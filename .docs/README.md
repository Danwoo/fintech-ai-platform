...
6. **도구** — 필요 시 [6-도구/](6-도구/): [하네스엔지니어링](6-도구/하네스엔지니어링.md) · [토큰절감](6-도구/토큰절감-rtk-serena.md) · [외부서비스모니터링](6-도구/외부서비스모니터링.md)
...
| `6-도구/`       | 개발·운영 도구 (rtk·serena, 외부서비스 모니터링)                             |
...
| [Claude Code 토큰 절감 (rtk + serena)](6-도구/토큰절감-rtk-serena.md) | 셸 출력 압축 + 심볼 단위 코드 도구                                                               |
